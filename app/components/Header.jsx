...
<div className='hidden font-jost transition delay-150 duration-300  ease-in-out items-center text-[16px] md:flex justify-between space-x-4 font-semibold'>
...
<a href="" className='  hover:text-red-600  hover:underline  underline-offset-6 px-3 py-2'>Resources</a> 
 <button className='bg-rose-600 hover:bg-rose-500 px-3 py-2.5 text-white rounded flex items-center text-[16px] ml-3.5'>Schedule A Meeting<MoveRight className='ml-1.5 w-4' /></button>
<div>
