...
const Airnbn = () => {
  return (
   ...
   <div className='md:flex gap-8 '>
      ...
      {/* first plate */}
      <div className='md:flex md:ml-16 ml-2.5  gap-6 md:flex-2 items-center justify-center mt-10 mb-10'>
        <div className='space-y-6 px-5  pt-8 md:w-88 md:h-150 border-2 border-rose-300 rounded'>
          ...
          <h1 className='w-70 h-10 border-2 pl-22 pt-1.5 text-rose-600 rounded border-rose-700'>Get Started Now</h1>
...
<div className='flex items-center' >
        ...
        {/* finished  */}
        {/* Second  */}
              <div className='space-y-6 px-5   bg-[#ED3C6A] pt-8 md:w-88  md:h-150 border-2 border-white rounded'>
          ...
          <h1 className='w-70 h-10 border-2 pl-22 pt-1.5 rounded border-white text-white'>Get Started Now</h1>
...
{/* second finished */}
{/* thired  */}
              <div className='space-y-6  pt-8 md:w-88 px-5  h-150 border-2 border-rose-300 rounded'>
